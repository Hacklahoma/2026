  ...
  return (
    <div className={`staff-page-container ${isDarkMode ? 'dark-mode' : ''}`}>
      ...
      <div className="staff-page-nav themed-card">
        <NavLink to="/staff/tech/home" className={({isActive}) => isActive ? "nav-link active" : "nav-link"}>
          Home
        </NavLink>
        <NavLink to="/staff/tech/registration" className={({isActive}) => isActive ? "nav-link active" : "nav-link"}>
          Registration
        </NavLink>
        <NavLink to="/staff/tech/admin" className={({isActive}) => isActive ? "nav-link active" : "nav-link"}>
          Admin
        </NavLink>
      </div>
