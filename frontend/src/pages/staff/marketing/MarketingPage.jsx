  ...
  return (
    <div className={`staff-page-container ${isDarkMode ? 'dark-mode' : ''}`}>
      ...
      <div className="staff-page-nav themed-card">
        <NavLink to="/staff/marketing/home" className={({isActive}) => isActive ? "nav-link active" : "nav-link"}>
          Home
        </NavLink>
        <NavLink to="/staff/marketing/assets" className={({isActive}) => isActive ? "nav-link active" : "nav-link"}>
          Assets
        </NavLink>
        <NavLink to="/staff/marketing/themeboard" className={({isActive}) => isActive ? "nav-link active" : "nav-link"}>
          Themeboard
        </NavLink>
      </div>
