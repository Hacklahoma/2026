  ...
  return (
    <div className={`staff-page-container ${isDarkMode ? 'dark-mode' : ''}`}>
      ...
      <div className="staff-page-nav themed-card">
        <NavLink to="/staff/sponsoring/home" className={({isActive}) => isActive ? "nav-link active" : "nav-link"}>
          Home
        </NavLink>
        <NavLink to="/staff/sponsoring/sponsors" className={({isActive}) => isActive ? "nav-link active" : "nav-link"}>
          Sponsors
        </NavLink>
        <NavLink to="/staff/sponsoring/budget" className={({isActive}) => isActive ? "nav-link active" : "nav-link"}>
          Budget
        </NavLink>
      </div>
